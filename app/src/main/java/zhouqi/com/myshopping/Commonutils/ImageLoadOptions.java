    ...
    public static DisplayImageOptions  build_item(){
        if(options_item==null){
            options_item = new DisplayImageOptions.Builder()
                    .showImageForEmptyUri(R.drawable.ic_chat_one)//如果url为空显示图片
                    .showImageOnLoading(R.drawable.ic_chat_two)//正在加载时显示的图片
                    .showImageOnFail(R.drawable.ic_chat_two)//加载失败显示的图片
