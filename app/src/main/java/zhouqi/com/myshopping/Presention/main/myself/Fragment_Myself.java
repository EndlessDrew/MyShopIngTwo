...
import zhouqi.com.myshopping.Presention.main.myself.UpdataImage.UpdataGoodsActivity;
import zhouqi.com.myshopping.R;

/**
 * 我的页面主页：包含登陆模块 注册模块 我的商品 上传商品等
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.rl_up_goods:
                if(state){
                    startActivity(new Intent(getActivity(),UpdataGoodsActivity.class));
                }else{
                    startActivity(new Intent(getActivity(),LoginActivity.class));
                }
                break;
